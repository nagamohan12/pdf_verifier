...
if Rails.env.production?
	org = Organization.create(name: 'Religare')
	user = User.create(username: 'Religare Admin',email:'religare@techrains.com',password: 'religare',role: 'admin',organization_id: org.id)
	User.create(username: 'Tester',email:'test@test.com',password: 'test@123',role: 'registered',organization_id: org.id)
